            ...
            <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow">
                ...
                <div class="mb-5">
                    ...
                    <select name="document_type" id="document_type"
                        ...
                        <option value="Berita Acara" {{ old('document_type') == 'Berita Acara' ? 'selected' : '' }}>Berita
                            Acara</option>
                        <option value="Resignation Letter"
                            {{ old('document_type') == 'Resignation Letter' ? 'selected' : '' }}>Resignation Letter</option>
                        <option value="Other Document" {{ old('document_type') == 'Other Document' ? 'selected' : '' }}>
                ...
                <div id="berita-acara-fields" class="hidden space-y-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="berita_acara[mo]" value="{{ old('berita_acara.mo') }}"
                                class="w-full border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="berita_acara[sid]" value="{{ old('berita_acara.sid') }}"
                                class="w-full border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="berita_acara[bw_prev]" value="{{ old('berita_acara.bw_prev') }}"
                                class="w-full border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="berita_acara[bw_new]" value="{{ old('berita_acara.bw_new') }}"
                                class="w-full border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="custom_file_name" id="custom_file_name"
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500"
                        placeholder="Masukkan nama custom tanpa ekstensi" value="{{ old('custom_file_name') }}">
        ...
        function updateFileNamePreview() {
            ...
            if (fileInput.files.length > 0) {
                ...
                if (customName) {
                    ...
                    previewText = originalFile.name;
                }
            } else {
                previewText = 'Tidak ada file dipilih';
            }
