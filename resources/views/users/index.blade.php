...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-dark-blue">Manajemen Pengguna</h1>
        <a href="{{ route('users.create') }}" class="bg-dark-blue text-white px-4 py-2 rounded hover:bg-gray-700 flex items-center gap-2">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                ...
                                @elseif($user->role === 'inputter') bg-blue-100 text-blue-800
